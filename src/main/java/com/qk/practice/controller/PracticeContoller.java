...
public class PracticeContoller {
    ...
    @RequestMapping(value = { "/getUncompletedPractice" }, method = RequestMethod.GET)
    @ResponseBody
    public Response getUncompletedPractice(@RequestBody Practice practice) {
    	...
    	//pi.setUserId(userId);
    	pi.setStatusId(CacheProcessor.CACHE_STATUS.get(StatusEnum.PROCESSING));
    	try {
